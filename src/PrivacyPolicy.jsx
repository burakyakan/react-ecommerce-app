  ...
  return (
    <div className={style.mainBox}>
      ...
      <div className={style.contentBox}>
        ...
        <p>biraziburada.com, değişen yasal mevzuatlar ve siber güvenlik standartları doğrultusunda bu Gizlilik Sözleşmesi’nde güncelleme yapma hakkını saklı tutar. Sözleşme hakkında merak ettiğiniz tüm sorular ve detaylı bilgi talepleri için bizimle <strong><a href="mailto:gizlilik@biraziburada.com">gizlilik@biraziburada.com</a></strong> e-posta adresi üzerinden dilediğiniz an iletişime geçebilirsiniz.</p>
